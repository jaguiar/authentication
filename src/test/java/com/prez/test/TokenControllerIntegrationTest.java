...
import com.prez.controller.TokenController;
...
public class TokenControllerIntegrationTest {
    ...
    public void shouldReturnEmptyListOfTokensWhenTokenStoreReturnNull() throws Exception {
        when(tokenStore.findTokensByClientId("randomClientId")).thenReturn(null);
    ...
    public void shouldReturnNotEmptyListOfTokens() throws Exception {
        when(tokenStore.findTokensByClientId("randomClientId")).thenReturn(generateTokens(1));
    ...
    public void shouldReturnListOfTokens() throws Exception {
        when(tokenStore.findTokensByClientId("randomClientId")).thenReturn(generateTokens(10));
